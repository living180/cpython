            ...
            if exists(new_path):
                ...
                if key in seen:
                    ...
                    if path is None:
                        ...
                        return ((join(new_path, rest) if rest else new_path),
                                False)
                else:
                    ...
                    if ok:
                        ...
                        return (join(path, rest) if rest else path), False
        return path, True
